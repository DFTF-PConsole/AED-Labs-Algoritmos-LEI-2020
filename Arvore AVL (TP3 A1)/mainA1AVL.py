...
class ArvoreAVL:
    ...
    def rotacao_esq(self, input_no_k1):    # Faz rotacao simples com filho k2 a esquerda, E -> D
        no_k2 = input_no_k1.esquerda
        input_no_k1.esquerda = no_k2.direita
        no_k2.direita = input_no_k1
        return no_k2

    def rotacao_dir(self, input_no_k1):    # Faz rotacao simples com filho k2 a direita, E <- D
        no_k2 = input_no_k1.direita
        input_no_k1.direita = no_k2.esquerda
    ...
    def rotacao_esq_dir(self, input_no_k1):    # Faz rotacao com filho k2 a direita | Faz rotacao com filho k2 a esquerda
        input_no_k1.esquerda = self.rotacao_dir(input_no_k1.esquerda)
    ...
    def rotacao_dir_esq(self, input_no_k1):    # Faz rotacao com filho k2 a esquerda | Faz rotacao com filho k2 a direita
        input_no_k1.direita = self.rotacao_esq(input_no_k1.direita)
    ...
    def inserir_elemento(self, input_raiz, input_elemento):
        if input_raiz is None:
            return input_elemento
        elif compara_str(input_raiz.elemento.palavra, input_elemento) == 1:
        ...
        if equilibrio > 1 and compara_str(input_raiz.esquerda.elemento.palavra, input_elemento.palavra) == 1:      # Esq
            return self.rotacao_dir(input_raiz)
        elif equilibrio < -1 and compara_str(input_raiz.direita.elemento.palavra, input_elemento.palavra) == 2:   # Dir
            ...
            if ch == '\n':
                if len(palavra) > 0:
                    ...
                    if elemento is not None:
                        ...
                        arvore_avl.inserir_elemento(arvore_avl.raiz, elemento)
                palavra = ""
